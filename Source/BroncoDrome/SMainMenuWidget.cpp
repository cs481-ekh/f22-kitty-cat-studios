...
void SMainMenuWidget::Construct(const FArguments &InArgs) {
  ...
  if (FileManager.FileExists(*file)) {
    ...
    FFileHelper::SaveStringToFile(
        TEXT(""), *FilePath, FFileHelper::EEncodingOptions::AutoDetect,
             ...
             .Padding(ScorePadding)
                 [SNew(SVerticalBox)
                  ...
                  SVerticalBox::Slot().Padding(
                      ButtonPadding)[SNew(STextBlock)
                                         .Font(ButtonTextStyle)
                                         .Text(score1) // these need to be FText
                                                       // not FString
                                         .Justification(ETextJustify::Center)
                                         .ColorAndOpacity(FColor::Orange)] +
                  SVerticalBox::Slot().Padding(
                      ButtonPadding)[SNew(STextBlock)
                                         .Font(ButtonTextStyle)
                                         .Text(score2) // these need to be FText
                                                       // not FString
                                         .Justification(ETextJustify::Center)
                                         .ColorAndOpacity(FColor::Orange)] +
                  SVerticalBox::Slot().Padding(
                      ButtonPadding)[SNew(STextBlock)
                                         .Font(ButtonTextStyle)
                                         .Text(score3) // these need to be FText
                                                       // not FString
                                         .Justification(ETextJustify::Center)
                                         .ColorAndOpacity(FColor::Orange)] +
                  SVerticalBox::Slot().Padding(
                      ButtonPadding)[SNew(STextBlock)
                                         .Font(ButtonTextStyle)
                                         .Text(score4) // these need to be FText
                                                       // not FString
                                         .Justification(ETextJustify::Center)
                                         .ColorAndOpacity(FColor::Orange)] +
                  SVerticalBox::Slot().Padding(
                      ButtonPadding)[SNew(STextBlock)
                                         .Font(ButtonTextStyle)
                                         .Text(score5) // these need to be FText
                                                       // not FString
                                         .Justification(ETextJustify::Center)
                                         .ColorAndOpacity(FColor::Orange)] +
                  SVerticalBox::Slot().Padding(
                      ButtonPadding)[SNew(STextBlock)
                                         .Font(ButtonTextStyle)
                                         .Text(score6) // these need to be FText
                                                       // not FString
                                         .Justification(ETextJustify::Center)
                                         .ColorAndOpacity(FColor::Orange)] +
                  SVerticalBox::Slot().Padding(
                      ButtonPadding)[SNew(STextBlock)
                                         .Font(ButtonTextStyle)
                                         .Text(score7) // these need to be FText
                                                       // not FString
                                         .Justification(ETextJustify::Center)
                                         .ColorAndOpacity(FColor::Orange)] +
                  SVerticalBox::Slot().Padding(
                      ButtonPadding)[SNew(STextBlock)
                                         .Font(ButtonTextStyle)
                                         .Text(score8) // these need to be FText
                                                       // not FString
                                         .Justification(ETextJustify::Center)
                                         .ColorAndOpacity(FColor::Orange)] +
                  SVerticalBox::Slot().Padding(
                      ButtonPadding)[SNew(STextBlock)
                                         .Font(ButtonTextStyle)
                                         .Text(score9) // these need to be FText
                                                       // not FString
                                         .Justification(ETextJustify::Center)
                                         .ColorAndOpacity(FColor::Orange)]
...
#undef LOCTEXT_NAMESPACE // // Copyright (C) Dromies 2021. All Rights Reserved.
