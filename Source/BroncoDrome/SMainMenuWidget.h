...
public:
	...
	void InitBroncoSave(int level, FName difficulty, bool practiceMode) const; //helper method to initialize the save
	FReply OnPlayClicked(FName difficulty) const;
	FReply OnFreePlayClicked(FName difficulty) const;
